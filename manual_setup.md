...
3. Create swapfile. (Originally from Autoware [troubleshooting section](https://autowarefoundation.github.io/autoware-documentation/main/support/troubleshooting/#build-issues))
   ...
   Building Autoware requires a lot of memory. On Jetsons with smaller amounts of memory, e.g., Jetson Orin Nano (Super), the Jetson can crash during a build because of insufficient memory. To avoid this problem, 16-32GB of swap should be configured. On a Jetson AGX Orin, this should not be necessary.
